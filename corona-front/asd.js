!(function(t, e, n, o, r) {
  function s(t, e, n, o) {
    ...
    a(t.find(".color"), r, 10, 48),
      ...
      e[3] >= 0
        ? (t.find(".special").show(), a(t.find(".special"), e[3], 10, 80))
        : t.find(".special").hide(),
      ...
      if (st && st.drawingID == st.myID) {
        if (ut.drawCommands.length > 0) {
          if (ut.drawCommands.length > 8) {
            ...
            it.emit("drawCommands", ut.drawCommands), (ut.drawCommands = []);
        }
  ...
  function b() {
    ...
    grecaptcha.execute.then
      ? grecaptcha.ready(function() {
          grecaptcha
            .execute("6LeFbcgUAAAAAHQcfuuaFjakmubtKjKCmYM5cbIJ", {
              action: "homepage"
            })
            .then(function(t) {
              (dt = t), w();
  ...
  function C(t, e) {
    at.playSound("playerJoin"),
      (it = io(t, { query: { token: dt } })),
      it.on("connect", function() {
        it.on("disconnect", function() {
          ...
          it.on("lobbyKicked", function(t) {
            ...
            null != e &&
              (st.chatAddMsg(null, e.name + " was kicked!", G),
              (e.kicked = !0));
          }),
          it.on("chat", function(t) {
            ...
            (n.id != st.drawingID && !n.guessedWord && o) ||
              st.chatAddMsg(e, v(t.message), o ? "#7dad3f" : "#000");
          }),
          it.on("lobbySpam", function() {
            st.chatAddMsg(
              null,
              "Spam detected! You're sending too many messages.",
              G
            );
          }),
          it.on("restartNotification", function(t) {
            st &&
              st.chatAddMsg(
                null,
                "Server will restart in about " + t + " seconds...",
                _
              );
          }),
          ...
          it.on("lobbyPlayerConnected", function(t) {
            st.addPlayer(t),
              st.chatAddMsg(null, t.name + " joined.", j),
              at.playSound("playerJoin");
          }),
          it.on("lobbyPlayerDisconnected", function(t) {
            var e = st.players.get(t);
            st.removePlayer(e),
              e.kicked || st.chatAddMsg(null, e.name + " left.", G),
              at.playSound("playerLeave");
          }),
          it.on("lobbyPlayerGuessedWord", function(t) {
            var e = st.players.get(t);
            st.setPlayerGuessed(e),
              st.chatAddMsg(null, e.name + " guessed the word!", N),
              t == st.myID && st.chatDisable(),
              at.playSound("playerGuessed");
          }),
          ...
          it.on("lobbyPlayerDrawing", function(t) {
            var e = st.players.get(t);
            st.setPlayerDrawing(e.id),
              st.chatAddMsg(null, e.name + " is drawing now!", O);
            var n = st.drawingID == st.myID;
            ut.setDrawing(n),
              n ? (f(), y()) : (p(), d()),
              at.playSound("roundStart"),
              D(st.timeMax),
              U();
          }),
          it.on("lobbyOwnerChanged", function(t) {
            var e = st.players.get(t);
            st.setPlayerOwner(e),
              st.chatAddMsg(null, e.name + " is the owner now!", N);
          }),
          it.on("lobbyRound", function(t) {
            (st.round = t),
              st.updateRound(),
              L({ mode: "text", text: "Round " + (st.round + 1) });
          }),
          it.on("lobbyChooseWord", function(t) {
            if (t.id == st.myID)
              L({ mode: "choosewords", text: "Choose a word", words: t.words });
            else {
              L({
                mode: "text",
          ...
          it.on("lobbyReveal", function(t) {
            A(),
              st.chatEnable(),
              st.chatAddMsg(null, "The word was '" + t.word + "'", N);
            ...
            st.updateRanks(),
              L({
                ...
                onshow: function() {
                  n
                    ? at.playSound("roundEndFailure")
                    : at.playSound("roundEndSuccess");
                }
              }),
              st.setPlayerDrawing(-1),
              ut.setDrawing(!1),
              st.playersResetGuessedWord();
          }),
  ...
  function I(t) {
    st.drawingID == st.myID
      ? (ut.drawCommands.push(t), ut.performDrawCommand(t))
      : ut.addDrawCommandReceived(t);
  }
  function L(t) {
  ...
  function R(t) {
    ...
    if ("reveal" == t.mode) {
      ...
      for (var i = 0; i < t.players.length; i++) {
        ...
        h.scoreGuessed > 0
          ? (f.text("+" + h.scoreGuessed), f.css("color", "#07EA30"))
          : (f.text(h.scoreGuessed), f.css("color", "#E81300")),
          l.append(p),
          l.append(f),
          u.append(l);
      }
    ...
    if ("endgame" == t.mode) {
      ...
      for (var i = 0; i < t.players.length; i++) {
        ...
        g.text("#" + h.rank),
          ...
          s(l, h.avatar, h.id == st.ownerID, h.rank <= 3 ? 2 : 1);
      }
    } else d.hide();
    o.show(),
      o.animate({ bottom: "0%" }, q, "easeInOutBack", function() {
        t.onshow && t.onshow();
      });
  }
  function U() {
    if (lt) {
      ...
      o
        ...
        : ((lt = !1),
          t.animate({ opacity: "0" }, W, function() {
            t.hide();
          }),
          e.animate({ bottom: "100%" }, W, "easeInOutBack", function() {
            e.hide();
    ...
    return (function(t) {
        ...
        function o(t, e) {
          ...
          return (
            e.forceNew || e["force new connection"] || !1 === e.multiplex || f
              ? (u("ignoring socket cache for %s", a), (n = c(a, e)))
              : (h[l] || (u("new io instance for %s", a), (h[l] = c(a, e))),
                (n = h[l])),
            o.query && !e.query
              ? (e.query = o.query)
              : e && "object" === s(e.query) && (e.query = r(e.query)),
            n.socket(o.path, e)
          );
        }
        function r(t) {
      ...
      function(n, o, r) {
        (function(s) {
          function i() {
            return (
              (void 0 !== e && "WebkitAppearance" in e.documentElement.style) ||
              (t.console &&
      ...
      function(n, o, r) {
        function s() {
          return (
            "WebkitAppearance" in e.documentElement.style ||
            (t.console &&
              (console.firebug || (console.exception && console.table))) ||
            (navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/) &&
              parseInt(RegExp.$1, 10) >= 31)
      ...
      function(t, e) {
        ...
        t.exports = function(t, e) {
          return (
            (e = e || {}), "string" == typeof t ? n(t) : e.long ? r(t) : o(t)
          );
        };
      },
      function(e, n, o) {
        (function(e, o) {
          ...
          (function() {
            function s(t, e) {
              ...
              "object" == typeof f &&
                f &&
                ((e.stringify = f.stringify), (e.parse = f.parse));
              var d,
                y,
                m,
                g = i.prototype,
                    ...
                    B = function(t, e, n, o, r, s, i) {
                      ...
                      if ("object" == typeof a && a)
                        if (
                          ...
                          if (P) {
                            for (
                              p = D(a / 864e5), u = D(p / 365.2425) + 1970 - 1;
                              P(u + 1, 0) <= p;
                              u++
                            );
                            for (
                      ...
                      for (var t, e, n, o, r, s = L, i = s.length; I < i; )
                        switch ((r = s.charCodeAt(I))) {
                          ...
                          default:
                            if (
                              ((e = I),
                              45 == r && ((o = !0), (r = s.charCodeAt(++I))),
                              r >= 48 && r <= 57)
                            ) {
                              for (
                                48 == r &&
                                  (r = s.charCodeAt(I + 1)) >= 48 &&
                                  r <= 57 &&
                                  N(),
                                  o = !1;
                                I < i && (r = s.charCodeAt(I)) >= 48 && r <= 57;
                                I++
                              );
          ...
          function o(t, n) {
            ...
            (n = n || {}),
              ...
              t
                ...
                : n.host && (n.hostname = h(n.host).host),
              (this.secure =
                null != n.secure
                  ? n.secure
          ...
          (t.exports = o),
            ...
            (o.prototype.probe = function(t) {
              ...
              function c(t) {
                h &&
                  t.name !== h.name &&
                  (a('"%s" works - aborting "%s"', t.name, h.name), n());
              }
              function u() {
          ...
          (t.exports = r),
                  ...
                  if (this.extraHeaders) {
                    ...
                    for (var r in this.extraHeaders)
                      this.extraHeaders.hasOwnProperty(r) &&
                        n.setRequestHeader(r, this.extraHeaders[r]);
                  }
                } catch (t) {}
                if (
            ...
            e.document &&
              (e.attachEvent
                ...
                : e.addEventListener &&
                  e.addEventListener("beforeunload", i, !1));
        }.call(
          e,
          (function() {
            return this;
      ...
      function(t, e, n) {
        (function(t) {
          ...
          function c(t, e, n) {
            for (
              var o = new Array(t.length), r = f(t.length, n), s = 0;
              s < t.length;
              s++
            )
              !(function(t, n, r) {
          ...
          (e.encodePacket = function(e, n, s, a) {
            ...
            return (
              void 0 !== e.data &&
                (u += s ? d.encode(String(e.data)) : String(e.data)),
              a("" + u)
            );
          }),
            ...
            (e.decodePacket = function(t, n, o) {
              ...
              if ("string" == typeof t) {
                ...
                var r = t.charAt(0);
                return Number(r) == r && b[r]
                  ? t.length > 1
                    ? { type: b[r], data: t.substring(1) }
                    : { type: b[r] }
                  : w;
              }
              var s = new Uint8Array(t),
                ...
                i = p(t, 1);
              return (
                k && "blob" === n && (i = new k([i])), { type: b[r], data: i }
              );
            }),
            (e.decodeBase64Packet = function(t, e) {
              ...
              return (
                "blob" === e && k && (o = new k([o])), { type: n, data: o }
              );
            }),
            ...
            (e.decodePayload = function(t, n, o) {
              ...
              for (var s, i, a = "", c = 0, u = t.length; c < u; c++) {
                ...
                if (":" != h) a += h;
                  ...
                  if (((i = t.substr(c + 1, s)), a != i.length))
                    return o(w, 0, 1);
                  if (i.length) {
                    if (
                      ((r = e.decodePacket(i, n, !0)),
                ...
                ? void c(t, o, function(t, e) {
                    ...
                    return (
                      e.forEach(function(t) {
                        ...
                        if (e) {
                          for (
                            var o = new Uint8Array(t.length), i = 0;
                            i < t.length;
                            i++
                          )
                            o[i] = t.charCodeAt(i);
                        ...
                        r[s++] = e ? 0 : 1;
                        for (
                          var a = n.byteLength.toString(), i = 0;
                          i < a.length;
                          i++
                        )
                          r[s++] = parseInt(a[i]);
            ...
            (e.encodePayloadAsBlob = function(t, n) {
              function o(t, n) {
                e.encodePacket(t, !0, !0, function(t) {
                  ...
                  for (
                    var s = t instanceof ArrayBuffer ? t.byteLength : t.size,
                      i = s.toString(),
            ...
            (e.decodePayloadAsBinary = function(t, n, o) {
              ...
              for (var r = t, s = [], i = !1; r.byteLength > 0; ) {
                for (
                  var a = new Uint8Array(r), c = 0 === a[0], u = "", h = 1;
                  255 != a[h];
                  h++
                ) {
                  if (u.length > 310) {
      ...
      function(t, e) {
        t.exports = function(t, e, n) {
          ...
          for (
            var r = new Uint8Array(t), s = new Uint8Array(n - e), i = e, a = 0;
            i < n;
            i++, a++
          )
            s[a] = r[i];
      ...
      function(t, e) {
        function n(t, e, n) {
          function r(t, o) {
            ...
            --r.count,
              t ? ((s = !0), e(t), (e = n)) : 0 !== r.count || s || e(null, o);
          }
          var s = !1;
        ...
        (function(t, r) {
          !(function(s) {
            ...
            var y,
              ...
              b = { version: "1.0.0", encode: h, decode: f };
            void 0 !==
              (o = function() {
                return b;
          ...
          a(s, i),
            ...
            (s.prototype.doWrite = function(t, n) {
              ...
              function r() {
                ...
                try {
                  var t =
                    '<iframe src="javascript:0" name="' + s.iframeId + '">';
                  i = e.createElement(t);
                } catch (t) {
                    ...
                    if (!o.usingBrowserWebSocket) {
                      ...
                      if (
                        ...
                        ("string" == typeof s
                          ...
                          : s.length) < o.perMessageDeflate.threshold &&
                          (i.compress = !1);
                      }
                    }
                    try {
        ...
        s(o.prototype),
          ...
          (o.prototype.onopen = function() {
            u("transport is open - connecting"),
              "/" !== this.nsp &&
                (this.query
                  ? this.packet({ type: r.CONNECT, query: this.query })
  ...
  var K = function(t, e) {
    ...
    V = function() {
      (this.context = null),
        (this.sounds = new Map()),
        (this.mute = !1),
        "true" === o.getItem("audioMute") && this.setMute(!0),
        t.addEventListener("load", this.load.bind(this), !1);
    };
  (V.prototype.setMute = function(t) {
    (this.mute = t),
      this.mute
        ? n("#audio").css("background-image", "url(res/audio_off.gif")
        : n("#audio").css("background-image", "url(res/audio.gif"),
      o.setItem("audioMute", this.mute.toString());
  }),
  ...
  var Z = function(t) {
    ...
    setInterval(function() {
      e.drawCommandsReceived.length > 0 &&
        e.performDrawCommand(e.drawCommandsReceived.shift());
    }, 3),
      this.clear();
  };
  (Z.prototype.updateMousePosition = function(t, e, n) {
    var o = this.canvas[0].getBoundingClientRect(),
      ...
      u = (e - o.top) / a;
    n
      ? ((this.mouseposPrev.x = this.mousepos.x = Math.floor(c * r)),
        (this.mouseposPrev.y = this.mousepos.y = Math.floor(u * s)))
    ...
    (Z.prototype.getPixel = function(t, e, n) {
      ...
      return o >= 0 && o < t.data.length
        ? [t.data[o], t.data[o + 1], t.data[o + 2]]
        : [0, 0, 0];
    }),
    (Z.prototype.floodFill = function(t, e, n, o, r) {
      var s = this.canvasCtx.getImageData(
          0,
          0,
          this.canvas[0].width,
      ...
      if (n != a[0] || o != a[1] || r != a[2]) {
        for (
          ...
          var l, p, f, d, y, m;
          for (
            l = i.pop(), p = l[0], f = l[1], d = 4 * (f * h + p);
            f-- >= 0 && c(d);

          )
            d -= 4 * h;
          for (d += 4 * h, ++f, y = !1, m = !1; f++ < u - 1 && c(d); )
    ...
    (Z.prototype.plotLineOld = function(t, e, n, o, r, s) {
      (this.canvasCtx.fillStyle = this.canvasCtx.strokeStyle = this.brush.getColor(
        s
      )),
    ...
    (Z.prototype.setDrawing = function(t) {
      t
        ? (this.brush.show(), n(".containerToolbar").show())
        : (this.brush.hide(), n(".containerToolbar").hide());
    });
  var Q = function() {
    (this.down = !1),
      (this.tool = "pen"),
  ...
  (Q.prototype.hide = function() {
    ...
    (Q.prototype.setTool = function(t) {
      (this.tool = t),
        ...
        n(".containerTools .tool[data-tool='" + t + "']").addClass(
          "toolActive"
        ),
    ...
    (Q.prototype.updateBrushCursor = function() {
      switch (this.tool) {
        ...
        case "erase":
          ...
          this.brushCanvasCtx.clearRect(
            0,
            0,
            this.thicknessMax,
            this.thicknessMax
          ),
            (this.brushCanvasCtx.fillStyle =
              "erase" == this.tool ? "#FFF" : this.getColor(this.colorIndex)),
            this.brushCanvasCtx.beginPath(),
            this.brushCanvasCtx.arc(
              this.thicknessMax / 2,
              this.thicknessMax / 2,
              this.thickness / 2 - 1,
              0,
        ...
        case "fill":
          n("#canvasGame").css(
            "cursor",
            "url(res/fill_graphic.png) 7 38, default"
          );
      }
    });
  var tt = function(t) {
  ...
  (tt.prototype.updatePlayerAvatars = function() {
    ...
    this.players.forEach(function(e, n, o) {
      s(
        t.containerGamePlayerGet(player),
        player.avatar,
        player.id == t.ownerID
      );
    });
    ...
    (tt.prototype.containerGamePlayersUpdateGuessed = function() {
      ...
      this.players.forEach(function(e, n, o) {
        ...
        e.guessedWord
          ? r.addClass("guessedWord")
          : r.removeClass("guessedWord");
      });
    }),
    ...
    (tt.prototype.containerLobbyUpdateUseCustomWordsExclusive = function() {
      n("#lobbyCustomWordsExclusive").attr(
        "checked",
        !!this.useCustomWordsExclusive
      );
    }),
    ...
    (tt.prototype.chatAddMsg = function(t, e, o) {
      ...
      if ((a.css("color", o), a.appendTo(r), t)) {
        n("<b/>", { text: t.name + ": " }).appendTo(a),
          this.playerMessage(t, e);
      } else a.css("font-weight", "bold");
      n("<span/>", { text: e }).appendTo(a),
  ...
  (nt.prototype.goto = function(t) {
    this.screenCurrent && this.screens[this.screenCurrent].hide(),
      ...
      this.screens[this.screenCurrent].logo > 0
        ? this.showLogo(this.screens[this.screenCurrent].logo)
        : this.hideLogo();
  }),
  ...
  (rt(ot, "skribbl-io.com") ||
    rt(ot, "skribblio.com") ||
    rt(ot, "skribbl-io.org")) &&
    (t.top.location.href = "https://www.skribbl.io"),
    aiptag.cmd.player.push(function() {
      ...
      (r.async = "async"),
        ...
        (r.onload = r.onreadystatechange = function() {
          !s ||
            ...
            ((s = !1), (r.onload = r.onreadystatechange = null));
        }),
        o.appendChild(r);
    })("//api.adinplay.com/libs/aiptag/pub/SKR/skribbl.io/tag.min.js"),
    n(function() {
  ...
  (ct.screens.game.onshow = function() {
    ...
    (function() {
      for (
        var t = n("#logoAvatarDummy"),
          e = n("#logoAvatarContainer"),
        ...
        (a[0] = r),
          ...
          (a[3] =
            1e3 * Math.random() < 70 ? Math.round(1 * Math.random()) : -1),
          s(i, a, r == o, 1);
      }
    })(),
    ...
    null != o.getItem("name") && n("#inputName").val(o.getItem("name")),
    n("#loginLanguage").change(function() {
      o.setItem("lang", n("#loginLanguage").val());
    }),
    null != o.getItem("lang") && n("#loginLanguage").val(o.getItem("lang")),
      ...
      return (
        t
          ...
          : ((t = [
            ...
            o.setItem("avatar", JSON.stringify(t))),
        t
      );
    })()),
    n("#buttonAvatarCustomizerRandomize").on("click", function() {
      return (
        (loginAvatarData[0] = Math.floor(Math.random() * J[0])),
  ...
  S(80),
    ...
    n("#buttonLobbyPlay").on("click", function() {
      it &&
        st.myID == st.ownerID &&
        it.emit("lobbyGameStart", n("#lobbySetCustomWords").val());
    }),
    n("#formChat").submit(function(t) {
      ...
      return (
        o &&
          (it
            ? it.emit("chat", o)
            : st.chatAddMsg(st.players.get(st.myID), o, "#000"),
          e.val("")),
        !1
      );
    }),
    ...
    ut.canvas.on("mousewheel DOMMouseScroll", function(t) {
      t.preventDefault();
      var e =
        t.originalEvent.wheelDelta > 0 || t.originalEvent.detail < 0 ? 1 : -1;
    ...
    n(e).keypress(function(t) {
      if (st && st.checkDrawing() && t !== r && t.key !== r)
